...
--// define
specsscripts.Name = "basya script ui v2 (original template by spec)"
...
makebtn("specs keyboard", "thanks for spec", "rbxassetid://75420967", function()
